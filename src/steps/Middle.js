...
class Middle extends Component {
    ...
    constructor(props) {
        ...
        const formState = props.getState()[1];
    ...
    componentDidMount() {
        console.log("Left Quadrant: ", this.props.getState());
    }

    nextPreprocess(){
        const { sixInch, twelveInch, eighteenInch } = this.state;
        // Save step state for use in other steps of the wizard
        this.props.saveState(1, { sixInch, twelveInch, eighteenInch });
        // Go to next step
        this.props.nextFn()
    }
